...
export const serviceConfig:Record<ServiceId,{name:string;termsVersion:string;roles:Set<string>;modes:Set<string>;tiers:Set<string>}>= {
 ...
 stamate:{name:"スタメイト",termsVersion:"2026-08-26-v2",roles:new Set(["アタッカー","タンク","サポート","コントロール","指定なし"]),modes:new Set(["トロフィー","ランク","イベント","フレンドバトル","その他"]),tiers:new Set(["ブロンズ","シルバー","ゴールド","ダイヤモンド","エリート","ミシック","レジェンド","マスター","未設定"])},
