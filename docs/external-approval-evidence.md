...
| NetEase Games | 名称、素材、API、収益化、一般公開                  | 2026-08-26の初回照会後、回答なし。公式サポート窓口へ2026-09-08に再照会       | 2026-09-08 | Gmail送信スレッド `1a067f69e79d25bc` | 送信済みメール（運営Gmail）  | 無料限定ベータ。一般公開・収益化は保留 |
