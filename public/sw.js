...
self.addEventListener("push",event=>{
  ...
  event.waitUntil(self.registration.showNotification(data.title,{body:data.body,icon:"/yunamatch-official-icon-v2.png",badge:"/yunamatch-official-icon-v2.png",tag:data.url,data:{url:data.url}}));
});
